...
/**
 * TestCase to ensure that the TAR exporters are working as
 * contracted
 *
...
public abstract class TarExporterTestBase extends StreamExporterTestBase
{
    ...
    * @throws IOException
    */
   private InputStream getEntryFromTarFile(final File archive, final ArchivePath path) throws IllegalArgumentException,
         IOException
   {
