...
/**
 * Defines the contract for a component capable of storing Manifest related resources. <br/>
 * <br/>
 * The actual path to the Manifest resources within the {@link Archive} is up to the implementations/specifications.
 *
...
public interface ManifestContainer<T extends Archive<T>> {
    String DEFAULT_MANIFEST_NAME = "MANIFEST.MF";
    ...
    /**
     * Adds the resource inside the package as a MANIFEST.MF to the container, returning the container itself. <br/>
     * <br/>
     * The {@link ClassLoader} used to obtain the resource is up to the implementation.
     *
    ...
    /**
     * Adds the resource as a Manifest resource to the container, returning the container itself. <br/>
     * The resource will be placed into the Container Manifest path under the same context from which it was retrieved. <br/>
     * <br/>
     * The {@link ClassLoader} used to obtain the resource is up to the implementation.
     *
     * @param resourceName
    ...
    /**
     * Adds the {@link File} as a Manifest resource to the container, returning the container itself. <br/>
