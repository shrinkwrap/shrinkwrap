...
public abstract class WebContainerBase<T extends Archive<T>> extends ContainerBase<T> implements WebContainer<T> {
     ...
     * (non-Javadoc)
     *
     * @see org.jboss.shrinkwrap.api.container.WebContainer#addWebResource(org.jboss.shrinkwrap.api.Asset,
     * java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.jboss.shrinkwrap.api.container.WebContainer#addWebResource(java.lang.String,
