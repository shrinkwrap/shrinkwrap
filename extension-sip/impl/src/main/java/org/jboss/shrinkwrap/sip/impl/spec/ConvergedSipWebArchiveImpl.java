...
import org.jboss.shrinkwrap.sip.impl.container.ConvergedSipWebContainerBase;
 ...
 * @version $Revision: $
 */
public class ConvergedSipWebArchiveImpl 
   extends ConvergedSipWebContainerBase<ConvergedSipWebArchive> 
   implements ConvergedSipWebArchive
{
   //-------------------------------------------------------------------------------------||
   // Class Members ----------------------------------------------------------------------||
   //-------------------------------------------------------------------------------------||
   ...
   private static final Logger log = Logger.getLogger(ConvergedSipWebArchiveImpl.class.getName());
    ...
    */
   public ConvergedSipWebArchiveImpl(final Archive<?> delegate)
   {
      super(ConvergedSipWebArchive.class, delegate);
   }
