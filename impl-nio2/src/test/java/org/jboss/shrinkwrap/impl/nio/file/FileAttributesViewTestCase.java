...
/**
 * ShrinkWrap implementation of {@link BasicFileAttributesView}; not all
...
public class FileAttributesViewTestCase {
	...
	public void getShrinkwrapAttributesView() {
		...
		Assert.assertEquals("Attributes view wrong name", ShrinkWrapFileAttributeView.class.getSimpleName(), attributeView.name());
		Assert.assertTrue("Attribute view is not an instance of ShrinkWrapFileAttributeView", attributeView instanceof ShrinkWrapFileAttributeView);
	}
	...
	public void readAttributes() throws IOException {
		...
		Assert.assertTrue("Atrributes are not instance of ShrinkWrapFileAttributes", attributes instanceof ShrinkWrapFileAttributes);
	}
	...
	private ShrinkWrapFileAttributeView  getAttributesView(final String pathName) {
		...
		return Files.getFileAttributeView(this.fs.getPath(pathName), ShrinkWrapFileAttributeView.class, (LinkOption) null);
	}
}
