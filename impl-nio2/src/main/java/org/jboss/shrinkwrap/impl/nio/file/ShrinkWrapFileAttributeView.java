...
/**
 * ShrinkWrap implementation of a {@link BasicFileAttributeView}; immutable and Thread-safe
 *
...
final class ShrinkWrapFileAttributeView implements BasicFileAttributeView {
    ...
    ShrinkWrapFileAttributeView(final ShrinkWrapFileAttributes attributes) {
    ...
    @Override
    public String name() {
        return ShrinkWrapFileAttributeView.class.getSimpleName();
    }
